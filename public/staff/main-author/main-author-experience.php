...
<article class="frame">
    ...
    <h1 class="institution-name"><?= $experience->company_name;?></h1>
    <h2 class="title"><?= $experience->job_title;?></h2>
    <div class="duration">
        <p>
            <strong>From &nbsp;</strong> <?= $experience->start_date;?> 
        </p>
        <p>
            <strong>&nbsp;To &nbsp;</strong><?= $experience->end_date;?></p>
    </div>
